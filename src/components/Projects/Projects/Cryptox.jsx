    ...
    return (
        <div className='project flex flex-col items-center' >
            <div className='w-10/12 '>
                <h1 className='text-white  pt-10 text-2xl md:text-4xl font-bold' data-aos="fade-right">Cryptox</h1>
                <h1 className='text-gray-500 text-lg md:text-2xl font-bold' data-aos="fade-right">Cryptocurrency stats site</h1>
                <div className='flex flex-col  lg:flex-row pt-5 gap-5'>
                    <img src={cryptox} alt="" className=' w-full lg:w-1/2 rounded-lg' data-aos="fade"/>
                    <div className='flex flex-col justify-between gap-4'>
                        <div className='summary'>
                            <h1 className='text-white text-xl md:text-3xl font-bold' data-aos="fade-left">Summary:</h1>
                            <p className='text-gray-500 text-lg md:text-2xl font-bold' data-aos="fade-left"> This is a Cryptocurrency stats site. It is a frontend application that uses React.js for the front-end with redux/toolkit. The application is hosted on vercel.</p>
                        </div>
