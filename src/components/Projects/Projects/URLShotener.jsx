    ...
    return (
        <div className='project flex flex-col items-center'>
            <div className='w-10/12 '>
                <h1 className='text-white  pt-10 text-4xl font-bold'>URL-Shortener</h1>
                <h1 className='text-gray-500  text-2xl font-bold'>Free URL-Shortening service</h1>
